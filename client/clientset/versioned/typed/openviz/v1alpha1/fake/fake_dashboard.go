...
var dashboardsResource = schema.GroupVersionResource{Group: "openviz.dev", Version: "v1alpha1", Resource: "dashboards"}

var dashboardsKind = schema.GroupVersionKind{Group: "openviz.dev", Version: "v1alpha1", Kind: "Dashboard"}
