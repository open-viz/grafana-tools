...
var datasourcesResource = schema.GroupVersionResource{Group: "openviz.dev", Version: "v1alpha1", Resource: "datasources"}

var datasourcesKind = schema.GroupVersionKind{Group: "openviz.dev", Version: "v1alpha1", Kind: "Datasource"}
