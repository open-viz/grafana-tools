...
import (
	...
	scheme "go.openviz.dev/grafana-operator/client/clientset/versioned/scheme"
...
func newDashboardTemplates(c *OpenvizV1alpha1Client, namespace string) *dashboardTemplates {
