		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"response": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("go.openviz.dev/grafana-tools/apis/ui/v1alpha1.EmbeddedDashboardResponse"),
						},
					},
				},
			},
...
func schema_grafana_tools_apis_ui_v1alpha1_EmbeddedDashboardRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_grafana_tools_apis_ui_v1alpha1_EmbeddedDashboardResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
