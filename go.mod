...
replace go.openviz.dev/apimachinery => ../apimachinery

replace kmodules.xyz/monitoring-agent-api => ../../kmodules.xyz/monitoring-agent-api

replace (
	github.com/google/cel-go => github.com/google/cel-go v0.22.1

	github.com/perses/perses v0.52.0 => ../../go.bytebuilders.dev/perses
