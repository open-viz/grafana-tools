...
const (
	ResourceKindPersesDashboard = "PersesDashboard"
	ResourcePersesDashboard     = "persesdashboard"
	ResourcePersesDashboards    = "persesdashboards"
)

const (
	PersesDashboardTitleKey = ".dashboard.title"
)
...
// +kubebuilder:resource:path=persesdashboards,singular=persesdashboard
...
type PersesDashboardSpec struct {
	// PersesRef defines the grafana app binding name for the GrafanaDashboard
	// +optional
	PersesRef *kmapi.ObjectReference `json:"persesRef,omitempty"`
...
type PersesDashboardReference struct {
...
type PersesDashboardList struct {
	...
	Items           []PersesDashboard `json:"items,omitempty"`
}
...
type PersesDashboardStatus struct {
	...
	// +optional
	Dashboard *PersesDashboardReference `json:"dashboard,omitempty"`
